...
public class Illuminations extends NslClass{
...
public void makeConn(){
	...
	/* GENERIC CONSTRUCTOR: */
	public Illuminations(String nslName, NslModule nslParent)
{
		super(nslName, nslParent);
		makeInstIlluminations(nslName, nslParent);
	}


	public Illuminations(String nslName, NslClass nslParent) {
		super(nslName, nslParent);
		makeInstIlluminations(nslName, nslParent);
	}

	public void makeInstIlluminations(String nslName, NslModule nslParent)
{ 
	...
	public void makeInstIlluminations(String nslName, NslClass nslParent) { 
		Object[] nslArgs=new Object[]{};
		callFromConstructorTop(nslArgs);
		dummy = new Illumination("dummy", this);
		callFromConstructorBottom();
