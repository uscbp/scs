...
nslImport CrowleyModel.CDmedinh.v1_1_1.src.*;
nslImport CrowleyModel.CDmedtan.v1_1_1.src.*;
nslImport CrowleyModel.CDmedburst.v1_1_1.src.*;
nslImport CrowleyModel.GPEmedburst.v1_1_1.src.*;
nslImport CrowleyModel.STNmedburst.v1_1_1.src.*;
nslImport CrowleyModel.SNRmedburst.v1_1_1.src.*;
nslImport CrowleyModel.MedBulk.v1_1_1.src.*;
nslImport CrowleyModel.Func.v1_1_1.src.*;
nslImport CrowleyModel._Element.v1_1_1.src.*;
...
public CDmedinh cdmedinh(CorticalArraySize,StriatalArraySize); // 
public CDmedtan cdmedtan(CorticalArraySize,StriatalArraySize); // 
public CDmedburst cdmedburst(CorticalArraySize,StriatalArraySize); // 
public GPEmedburst gpemedburst(CorticalArraySize); // 
public STNmedburst stnmedburst(CorticalArraySize); // 
public SNRmedburst snrmedburst(CorticalArraySize,StriatalArraySize); // 
public MedBulk medbulk1(CorticalArraySize,MaxConnections); // 
...
private NslDouble0 LearnRate(.05); // 
