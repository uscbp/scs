...
public class _Target extends NslClass{
...
public void makeConn(){}
	...
	/* GENERIC CONSTRUCTOR: */
	public _Target(String nslName, NslModule nslParent)
{
		super(nslName, nslParent);
		makeInst_Target(nslName, nslParent);
	}


	public _Target(String nslName, NslClass nslParent) {
		super(nslName, nslParent);
		makeInst_Target(nslName, nslParent);
	}

	public void makeInst_Target(String nslName, NslModule nslParent)
{ 
