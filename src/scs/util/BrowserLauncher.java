        ...
        switch (jvm)
        {
            case MRJ_2_0:
                try
                {
                    ...
                    Class.forName("com.apple.MacOS.MacOSError");
        ...
        switch (jvm)
        {
            case MRJ_2_0:
                try
                {
                    ...
                    // me know.
                    return appleEventConstructor.newInstance(new Object[]{gurlType, gurlType, aeTarget,
    ...
    public static void openURL(String url) throws IOException
    {
        ...
        switch (jvm)
        {
            ...
            case OTHER:
                ...
                Process process = Runtime.getRuntime().exec(browser + NETSCAPE_OPEN_PARAMETER_START + url +
