 ...
 */
public class JEditTextArea extends JComponent implements Serializable
{
	/**
	...
	{
                //super();
                //UIManager.put(super.getUIClassID(), "JEditTextArea");
        ...
        public void setVerticalScrollBar(JScrollBar vs)
        {
            vertical = vs;
            vertical.addAdjustmentListener(new AdjustHandler());
...
//	}
    ...
    public void setDocument(PlainDocument d)
	{
		...
		if(this.document != null){
		 this.document.removeDocumentListener(documentHandler);
		 tm = this.document.getTokenMarker();
		}
		
		this.document = new SyntaxDocument(d);
		//this.document = new SyntaxDocument();
		
		this.document.addDocumentListener(documentHandler);
		
		UndoableEditListener[] dl = d.getUndoableEditListeners();
		if(dl != null)
		{
			for(int i = 0 ; i < dl.length; i++)
			{
				this.document.addUndoableEditListener(dl[i]);
			}
		}
		
		DocumentListener[] d2 = d.getDocumentListeners();
		if(d2 != null)
		{
			for(int i = 0 ; i < d2.length; i++)
			{
				this.document.addDocumentListener(d2[i]);
			}
		}
		...
		if(tm != null)
			this.document.setTokenMarker(tm);
	...
	public void setText(String text)
	{
		...
		finally
		{
       	...
       	public void insertText(String text, int begin)
	{
		try
		{
			document.beginCompoundEdit();
			document.insertString(begin,text,null);
		}
		catch(BadLocationException bl)
		{
			bl.printStackTrace();
	...
	public void select(int start, int end)
	{
		...
		if(newStart < 0 || newEnd > getDocumentLength())
		{
            /*throw new IllegalArgumentException("Bounds out of"
				+ " range: " + newStart + "," +
				newEnd);*/
            System.out.println("IgnoringBounds out of range: " + newStart + ","+newEnd);
        }
